...
class User(object):
    ...
    def need_update(self, source):
        ...
        print(f'2 - \"source.avatarUrl != source.avatarUrl\" {source.avatarUrl != "https://cdn.discordapp.com/avatars/225743846934446081/afc9af98a91cb4a6f1d24d9a7c9982dc.webp?size=1024"}')
